    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (isWork)
            {
                    ...
                    if (heroHealth > 0 && bossHealth > 0)
                    {
                        ...
                        switch (userChose)
                        {
                            ...
                            case "2":
                                ...
                                if (heroMana >= shadowWarriorNeedMana)
                                {
                                        ...
                                        if (shadowWarriorHealth > 0)
                                        {
                                            ...
                                            switch (userChoseShadowWarrior)
                                            {
                                                case "1":
                                                    ...
                                                    break;
                                                case "2":
                                                    if (heroMana >= upgradeDamegeShadowWarrior)
                                                    {
                                ...
                                break;
                            case "3":
                                if (heroHealth < heroHealthMax && heroMana > 0)
                                {
                            ...
                            case "4":
                                ...
                                if (heroMana > manaNeedForUpArmor)
                                {
                                    ...
                                    Random randomArmorHero = new Random();
                                    int randomArmor = randomArmorHero.Next(minRandomArmor, maxRandomArmor);
                                    heroMana -= manaNeedForUpArmor;
                                    heroArmor += randomArmor;
                                }
                                else
                                {
                                    Console.WriteLine($"Недостаточно маны или броня максимально усилина!");
                                }
                                break;
                            case "5":
                ...
                {
                    Console.WriteLine("Босс не пробил вашу броню, в результате пришел в ярость его урон увеличился!");
                    bossDamage += bossUpDamage;
                }
            }
        }
    }
